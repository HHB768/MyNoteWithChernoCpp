...
//void main()
//{
//    std::cout << a << std::endl;  // you can see that data is just number and its type actually make no sense, but when we write a function, we are expecting a type of variable.
//    std::cout << b << std::endl;
